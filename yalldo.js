...
$(document).ready(function() {
	...
	click("plus",function() { toggle('plusmenu'); });
...
function openmenu() {
	// open hamburger menu
	if(!appgyver) {
		if(menuopen) { style("page","left","0px"); style("pagebg","left","0px"); style("banner","left","0px"); $('html,body').css('overflow','auto'); show("plus"); }
		else { style("page","left","540px"); style("pagebg","left","540px"); style("banner","left","540px"); $('html,body').css('overflow','hidden'); hide("plus"); hide("plusmenu"); } hide("menu2");	
	} else {
...
function opennoti() {
	...
	if(!appgyver) {
		if(menuopen) { style("page","left","0px"); style("pagebg","left","0px"); style("banner","left","0px"); $('html,body').css('overflow','auto'); show("plus"); }
		else { style("page","left","-540px"); style("pagebg","left","-540px"); style("banner","left","-540px"); $('html,body').css('overflow','hidden'); hide("plus"); hide("plusmenu"); } show("menu2");
	} else {
